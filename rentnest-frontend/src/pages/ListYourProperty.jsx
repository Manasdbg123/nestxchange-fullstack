...
export default function ListYourProperty() {
    usePageMeta({
        ...
        description:
            'Post your flat, house, PG or commercial space on RentNest at no cost. Reach tenants directly, keep the brokerage, and manage viewings in one place.',
    });
        ...
        <>
            ...
            <section className="bg-white py-16 dark:bg-ink-950">
                <div className="container-page">
                    <SectionHeading
                        eyebrow="Why post on RentNest"
                        title="Built for owners, not for agents"
                        description="Every part of the flow assumes you are the person who owns the place - because on RentNest, you are."
                    />
